        ...
        <main className="flex-1 flex flex-col items-center justify-center px-6 py-20">
          <div className="w-full max-w-lg">
            ...
            <p className="text-zinc-500 text-base leading-relaxed mb-10">
              Enter your address to analyse your property&rsquo;s subdivision
              potential — lot size, existing structures, and available space.
            </p>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-3">
              <div className="relative">
                <input
                  ...
                  className="w-full border border-zinc-300 rounded-lg px-4 py-3.5 text-base text-zinc-900 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-zinc-900 focus:border-transparent"
                  disabled={loading}
                  autoComplete="off"
                />
                {selectedPlace && (
              ...
              <button
                ...
                className="w-full bg-zinc-900 text-white py-3.5 rounded-lg font-medium text-base hover:bg-zinc-700 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
              >
                {loading ? (
